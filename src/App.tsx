...
function KlarnaTrustBadge() {
  return (
    <div className="flex w-full max-w-[18.5rem] items-center gap-2.5 rounded-[1.25rem] border border-white/70 bg-white/[0.9] p-3 pr-3 text-left text-[#030303] shadow-[0_18px_60px_rgba(3,3,3,0.12)] backdrop-blur-xl sm:w-fit sm:max-w-[25rem] sm:gap-3 sm:rounded-[1.4rem] sm:border-[#ffc2dc] sm:bg-[#FFA8CD] sm:p-3.5 sm:pr-4 sm:shadow-[0_18px_60px_rgba(98,21,55,0.18)]">
    ...
    <div className="flex min-h-[100dvh] w-full items-center justify-center bg-[#f0f0f0] py-3 md:py-5" id="top">
      <section className="site-shell hero-shell group relative flex flex-col items-center overflow-hidden rounded-[1.5rem] md:rounded-[3rem]">
        ...
        <div className="relative z-10 flex min-h-[inherit] w-full flex-col items-center">
          ...
          <div className="mt-5 w-full px-4 md:px-6 lg:px-10">
            <KlarnaTrustBadge />
          </div>
          <BottomLeftCard />
          <BottomRightCorner />
...
const simulatorAccessToken = "38fcadf409b8465fda7f1b5a4457145cd5ce";
      ...
      <div className="flex flex-col gap-3 rounded-[1.35rem] bg-white p-5 text-[#030303] shadow-[0_18px_54px_rgba(17,24,39,0.06)] sm:flex-row sm:items-center sm:justify-between sm:rounded-[2rem] sm:p-6">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-[14px] leading-[1.55] text-gray-600 sm:text-[15px]">
              <strong className="break-words font-semibold text-[#030303]">Die Abbuchung erfolgt durch Digistore24 GmbH (Deutschland).</strong>
            </p>
          </div>
        </div>
